...
- 2026-09-03 — resolved: `src/lib/queries/getNationalityNames.ts` unit coverage (Test coverage item 3)
...
- [x] `src/lib/queries/getNationalityNames.ts` has 0% unit coverage, untested alongside its DJ/genre counterparts (found: 2026-09-01) (resolved: 2026-09-03, PR #386)
