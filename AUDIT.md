...
- [x] `src/lib/api.ts`'s `fetchGraphQL` has no test for `fetch()` itself rejecting/throwing (network failure) or `response.json()` throwing on malformed JSON (found: 2026-09-01) (resolved: 2026-09-05, PR #TBD)
