...
- [x] `src/pages/genres.astro:20` passes `pageTitle="Home"` to `BaseLayout` — wrong/duplicate title identical to the actual homepage (found: 2026-09-01) (resolved: 2026-09-24, PR #TBD)
